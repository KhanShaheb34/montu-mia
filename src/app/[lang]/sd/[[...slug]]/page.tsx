...
export async function generateMetadata(
  ...
  // Locale-aware static OG image (with version for cache busting). Guard
  // against empty slug array to avoid paths like /og/sd//image.png.
  // Bengali (default) keeps the original /og/sd/... path; other locales use
  // /og/<lang>/sd/... — both are pre-generated by `bun run generate-og`.
